      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className={`text-center lg:text-left transition-all duration-1000 ${
            ...
            <div className="inline-block bg-red-50 text-red-600 px-4 py-2 rounded-full text-sm font-semibold mb-6 animate-fade-in">
              {content.subtitle}
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight animate-fade-in delay-200">
              {content.title.split(' ')[0]}
              <span className="block text-red-600">{content.title.split(' ').slice(1).join(' ')}</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-2xl animate-fade-in delay-400">
              {content.description}
            </p>
          ...
          <div className={`relative transition-all duration-1000 delay-500 ${
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-100 text-center transform hover:scale-105 transition-all duration-500">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Reswara Praptama</h3>
                <p className="text-gray-600 mb-6">Professional Engineering Consultant</p>
